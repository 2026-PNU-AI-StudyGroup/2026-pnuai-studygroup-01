...
- Accent: Campus Gold `#D58A00` — one focal cue per screen at most, such as the discovery sparkle, deadline emphasis, unread marker, or timeline point
...
- Semantic resolve: Campus Gold is decorative and navigational only; warning keeps its darker semantic token and warning copy never relies on gold alone. Success and danger remain reserved for matching states
...
- Color expression: Cobalt communicates action and location; Campus Gold supplies one warm focal cue and never competes with the primary action or semantic states
