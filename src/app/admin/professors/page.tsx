...
export default async function ProfessorsPage() {
  ...
  return (
    <AppShell role={actor.role} userName="부산대학교" currentPath="/admin/professors">
      <main className="content-shell space-y-12">
        <PageHeader eyebrow="Administration" title="교수 권한 관리" description="사전 등록된 부산대학교 이메일만 교수 기능을 사용할 수 있습니다." />
