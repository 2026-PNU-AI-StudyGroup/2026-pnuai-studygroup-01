...
export default async function AcademicCyclesPage() {
  ...
  return (
    <AppShell role={actor.role} userId={actor.id} userName={actor.name} currentPath="/admin/academic-cycles">
      <AdminWorkspace currentPath="/admin/academic-cycles" title="운영 학기" description="프로그램과 주제 운영의 기준이 되는 학년도와 학기를 관리합니다." actions={<Link className="button-primary" href="/admin/academic-cycles/new">새 학기 등록</Link>}>
