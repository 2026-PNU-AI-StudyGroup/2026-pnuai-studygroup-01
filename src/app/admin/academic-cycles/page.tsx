...
export default async function AcademicCyclesPage() {
  ...
  return (
    <AppShell role={actor.role} userName="부산대학교" currentPath="/admin/academic-cycles">
      <main className="content-shell space-y-12">
        <PageHeader eyebrow="Administration" title="학기 관리" description="주제와 팀 운영의 기준이 되는 학년도·학기를 등록합니다." />
