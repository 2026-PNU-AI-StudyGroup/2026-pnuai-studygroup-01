  ...
  return (
    <AppShell role={actor.role} userName="부산대학교" currentPath="/professor/applications">
      <main className="content-shell space-y-10">
        <PageHeader eyebrow="Application review" title="지원 검토" description="학생의 지원 동기, 보유 기술, 희망 역할과 활동 가능 시간을 확인하고 팀 참여 여부를 결정하세요." actions={<Link href="/professor/topics" className="button-secondary">주제 관리</Link>} />
