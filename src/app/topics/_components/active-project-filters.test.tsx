...
describe("ActiveProjectFilters", () => {
  ...
  it("분과를 고르면 검색어만 보존하고 첫 페이지로 이동한다", () => {
    render(<ActiveProjectFilters programId="program-1" query="길찾기" operation="overdue" divisions={[{ id: "division-1", name: "AI" }]} />);
    ...
    expect(push).toHaveBeenCalledWith("/topics?programId=program-1&divisionId=division-1&q=%EA%B8%B8%EC%B0%BE%EA%B8%B0&operation=overdue", { scroll: false });
  });
});
