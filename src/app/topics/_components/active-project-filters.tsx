...
export function ActiveProjectFilters({ programId, query, divisionId, divisions = [], hasUnassigned = false, teamStatus, reportStatus }: {
  programId?: string;
  query: string;
