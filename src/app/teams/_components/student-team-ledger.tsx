          ...
          return (
            <li key={team.id} className={`record-row grid gap-5 px-2 py-6 xl:items-center xl:gap-5 ${teamLedgerColumns}`}>
              <div className="min-w-0">
                <p className="mb-1 text-xs font-bold text-[var(--muted)] xl:hidden"><UiText>{"팀"}</UiText></p>
              ...
              <div>
                <p className="mb-1.5 text-xs font-bold text-[var(--muted)] xl:hidden"><UiText>{"내 역할"}</UiText></p>
                <StatusBadge tone={isLeader ? "info" : "neutral"}><UiText>{isLeader ? "팀장" : "팀원"}</UiText></StatusBadge>
              </div>
              <div className="min-w-0">
                <p className="mb-1 text-xs font-bold text-[var(--muted)] xl:hidden"><UiText>{"구성원"}</UiText></p>
              ...
              <div>
                <p className="mb-1 text-xs font-bold text-[var(--muted)] xl:hidden"><UiText>{"검토 대기"}</UiText></p>
              ...
              <div className="xl:text-right">
                <p className="mb-1 text-xs font-bold text-[var(--muted)] xl:hidden"><UiText>{"관리"}</UiText></p>
