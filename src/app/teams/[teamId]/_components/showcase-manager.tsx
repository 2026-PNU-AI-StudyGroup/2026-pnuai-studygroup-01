...
export function ShowcaseManager({
  ...
  // 서버가 새 순서/목록으로 리프레시하면 로컬 드래그 상태를 동기화한다.
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <input ref={thumbnailInputRef} type="file" accept={IMAGE_ACCEPT} className="sr-only" tabIndex={-1} aria-hidden="true" onChange={pickThumbnail} />
      </div>
      ...
      <div className="space-y-3">
        ...
        <input ref={galleryInputRef} type="file" accept={IMAGE_ACCEPT} multiple className="sr-only" tabIndex={-1} aria-hidden="true" onChange={addImages} />
        {order.length === 0 ? (
