    ...
    <AppShell role={actor.role} userName={actor.name} currentPath="/dashboard">
      <main className="content-shell space-y-12">
        ...
        <section aria-labelledby="discussion-title" className="space-y-5">
          <div><p className="eyebrow">소통</p><h2 id="discussion-title" className="mt-1 text-2xl font-bold">팀 토론</h2><p className="muted mt-2 text-sm">팀원과 지도교수가 의견을 공유합니다. 필요한 글은 한국어 또는 영어로 바로 번역할 수 있습니다.</p></div>
