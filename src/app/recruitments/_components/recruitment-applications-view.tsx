      ...
      <div className="overflow-hidden rounded-[var(--radius-panel)] border border-[var(--line)] bg-white">
        <section aria-labelledby="recruitment-content-title" className="grid gap-6 border-b border-[var(--line)] px-7 py-7 lg:grid-cols-[12rem_minmax(0,1fr)] lg:px-9">
          <div>
            <div className="flex items-center gap-3">
              <h2 id="recruitment-content-title" className="text-base font-black text-[var(--ink)]"><UiText>{"모집 내용"}</UiText></h2>
        ...
        <section aria-labelledby="applicant-list-title">
          <div className="border-b border-[var(--line)] bg-[var(--surface-subtle)] px-7 py-4 lg:px-9">
            <h2 id="applicant-list-title" className="text-sm font-black text-[var(--ink)]"><UiText>{"지원자"}</UiText></h2>
          </div>
                  ...
                  <article className="grid gap-6 lg:grid-cols-[11rem_minmax(0,1fr)_auto]">
                    ...
                    <div className="min-w-0">
                      <dl className="grid gap-5 text-sm sm:grid-cols-3">
                        <div><dt className="text-xs font-semibold text-[var(--muted)]"><UiText>{"보유 기술"}</UiText></dt><dd className="mt-1 font-bold"><UiText>{application.skills.join(", ")}</UiText></dd></div>
                        <div><dt className="text-xs font-semibold text-[var(--muted)]"><UiText>{"희망 역할"}</UiText></dt><dd className="mt-1 font-bold"><UiText>{application.desiredRole}</UiText></dd></div>
                        <div><dt className="text-xs font-semibold text-[var(--muted)]"><UiText>{"활동 가능 시간"}</UiText></dt><dd className="mt-1 font-bold"><UiText>{application.availability}</UiText></dd></div>
                      </dl>
