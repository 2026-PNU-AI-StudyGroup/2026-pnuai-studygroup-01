  ...
  return (
    <form action={action} aria-busy={pending} className="border-b border-[var(--line)]">
      <div className="grid gap-3 border-b border-[var(--line)] py-7 lg:grid-cols-[13rem_minmax(0,1fr)] lg:gap-12">
        <span>
          <label htmlFor="profile-interests" className="block text-sm font-bold"><UiText>{"관심 분야"}</UiText></label>
      ...
      <div className="grid gap-3 border-b border-[var(--line)] py-7 lg:grid-cols-[13rem_minmax(0,1fr)] lg:gap-12">
        <span>
          <label htmlFor="profile-skills" className="block text-sm font-bold"><UiText>{"보유 기술"}</UiText></label>
      ...
      <div className="grid gap-3 border-b border-[var(--line)] py-7 lg:grid-cols-[13rem_minmax(0,1fr)] lg:gap-12">
        <span>
          <label htmlFor="profile-role" className="block text-sm font-bold"><UiText>{"희망 역할"}</UiText></label>
      ...
      <div className="grid gap-3 border-b border-[var(--line)] py-7 lg:grid-cols-[13rem_minmax(0,1fr)] lg:gap-12">
        <span>
          <label htmlFor="profile-availability" className="block text-sm font-bold"><UiText>{"활동 가능 시간"}</UiText></label>
      ...
      <div className="grid gap-3 border-b border-[var(--line)] py-7 lg:grid-cols-[13rem_minmax(0,1fr)] lg:gap-12">
        <span>
          <label htmlFor="profile-bio" className="block text-sm font-bold"><UiText>{"자기소개"}</UiText></label>
