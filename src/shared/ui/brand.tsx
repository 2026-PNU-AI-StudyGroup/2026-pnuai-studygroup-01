...
export function Brand({ inverse = false, href = "/" }: { inverse?: boolean; href?: string }) {
  return (
    ...
    >
      <span aria-hidden="true" className="block h-9 w-[146px] bg-[var(--accent)] [mask-image:url('/brand/pusan-national-university.png')] [mask-position:left_center] [mask-repeat:no-repeat] [mask-size:contain]" style={inverse ? { backgroundColor: "white" } : undefined} />
