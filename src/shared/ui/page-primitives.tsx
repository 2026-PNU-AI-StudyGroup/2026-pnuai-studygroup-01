  ...
  return (
    <header className={`flex flex-col sm:flex-row sm:items-end sm:justify-between ${compact ? "gap-4" : "gap-6"}`}>
      <div className="max-w-3xl">
        <p className="text-xs font-bold tracking-[0.14em] text-[var(--primary)]"><UiText>{eyebrow}</UiText></p>
        <h1 className={`${compact ? "mt-1.5 text-[clamp(1.75rem,3vw,2.125rem)]" : "mt-2 text-[clamp(2.1rem,4vw,3rem)]"} font-bold leading-[1.08] tracking-[-0.055em] text-[var(--ink)]`}><UiText>{title}</UiText></h1>
