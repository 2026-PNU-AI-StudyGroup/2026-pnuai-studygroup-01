    ...
    <details className="group lg:hidden">
      <summary className="flex min-h-[4.5rem] cursor-pointer list-none items-center gap-3 border-y border-[var(--line)] py-3 [&::-webkit-details-marker]:hidden">
        <span className="min-w-0 flex-1">
          <span className="block text-[0.68rem] font-black uppercase tracking-[0.1em] text-[var(--muted)]">
            {eyebrow}
          </span>
          <strong className="mt-1 block truncate text-sm font-black text-[var(--ink)]">
            {label}
          </strong>
        </span>
