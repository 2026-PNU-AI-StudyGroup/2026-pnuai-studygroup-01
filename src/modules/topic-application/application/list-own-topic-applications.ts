...
export class ListOwnTopicApplicationsService {
  ...
  async execute(actor: CurrentActor, requestedPage = 1, requestedPageSize = 20): Promise<TopicApplicationPage> {
    ...
    return this.repository.listByStudent(actor.id, page, pageSize);
  }
