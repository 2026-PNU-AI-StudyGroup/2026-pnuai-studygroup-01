...
DROP TRIGGER stored_file_attached_immutability ON "stored_file";
CREATE TRIGGER stored_file_attached_immutability
BEFORE UPDATE OF "status", "teamId", "ownerId", "purpose", "objectKey", "uploadObjectKey", "originalName", "contentType", "size", "sha256"
ON "stored_file"
