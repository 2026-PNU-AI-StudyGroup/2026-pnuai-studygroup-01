...
export function buildDemoProgramAnnouncements(
  ...
  // 학생 등록형 프로그램은 별도 모집 기간이 없으므로 프로그램 시작부터 수행 시작 전까지를
